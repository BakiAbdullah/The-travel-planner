  ...
  return (
    <div className="navbar container mx-auto px-10 py-7">
      <div className="navbar-start">
        ...
        <img className=" text-black w-[100px] mr-16" src={logoBlack} alt="" />
        <form>
          <label
            for="search"
          ...
          <div class="relative min-w-full">
            ...
            <input
              type="search"
              id="search"
              class="block bg-opacity-40 w-full p-2 pl-10 text-sm text-black border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:outline-none placeholder:text-black  focus:border"
